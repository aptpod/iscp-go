...
func (*UpstreamCallExtensionFields) Descriptor() ([]byte, []int) {
	return fileDescriptor_296a7f0577998ea8, []int{0}
}
...
func (*UpstreamCallAckExtensionFields) Descriptor() ([]byte, []int) {
	return fileDescriptor_296a7f0577998ea8, []int{1}
}
...
func (*DownstreamCallExtensionFields) Descriptor() ([]byte, []int) {
	return fileDescriptor_296a7f0577998ea8, []int{2}
}
...
func init() {
	proto.RegisterType((*UpstreamCallExtensionFields)(nil), "iscp2.UpstreamCallExtensionFields")
	proto.RegisterType((*UpstreamCallAckExtensionFields)(nil), "iscp2.UpstreamCallAckExtensionFields")
	proto.RegisterType((*DownstreamCallExtensionFields)(nil), "iscp2.DownstreamCallExtensionFields")
}

func init() { proto.RegisterFile("extensions/e2e_call.proto", fileDescriptor_296a7f0577998ea8) }

var fileDescriptor_296a7f0577998ea8 = []byte{
	// 175 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x4c, 0xad, 0x28, 0x49,
	0xcd, 0x2b, 0xce, 0xcc, 0xcf, 0x2b, 0xd6, 0x4f, 0x35, 0x4a, 0x8d, 0x4f, 0x4e, 0xcc, 0xc9, 0xd1,
	...
	0x26, 0x95, 0xa6, 0x81, 0x79, 0x60, 0x0e, 0x98, 0x05, 0xd1, 0xa5, 0x24, 0xcb, 0x25, 0x1d, 0x5a,
	0x50, 0x5c, 0x52, 0x94, 0x9a, 0x98, 0xeb, 0x9c, 0x98, 0x93, 0xe3, 0x0a, 0x33, 0xde, 0x2d, 0x33,
	0x35, 0x27, 0xa5, 0x58, 0x49, 0x81, 0x4b, 0x0e, 0x59, 0xda, 0x31, 0x39, 0x1b, 0x5d, 0x85, 0x3c,
	0x97, 0xac, 0x4b, 0x7e, 0x79, 0x1e, 0x4e, 0x23, 0x9c, 0x14, 0x4e, 0x3c, 0x94, 0x63, 0xf8, 0xf1,
	0x50, 0x8e, 0x71, 0xc5, 0x23, 0x39, 0xc6, 0x1d, 0x8f, 0xe4, 0x18, 0x0f, 0x3c, 0x92, 0x63, 0x3c,
	0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x93, 0xd8, 0xc0, 0x4e,
	0x31, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xa6, 0x95, 0x7b, 0x65, 0xdd, 0x00, 0x00, 0x00,
}

func (this *UpstreamCallExtensionFields) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UpstreamCallExtensionFields)
	if !ok {
		that2, ok := that.(UpstreamCallExtensionFields)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *UpstreamCallAckExtensionFields) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UpstreamCallAckExtensionFields)
	if !ok {
		that2, ok := that.(UpstreamCallAckExtensionFields)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *DownstreamCallExtensionFields) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*DownstreamCallExtensionFields)
	if !ok {
		that2, ok := that.(DownstreamCallExtensionFields)
		if ok {
			that1 = &that2
		} else {
			return false
...
func NewPopulatedUpstreamCallExtensionFields(r randyE2ECall, easy bool) *UpstreamCallExtensionFields {
	this := &UpstreamCallExtensionFields{}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedE2ECall(r, 1)
	}
	return this
}

func NewPopulatedUpstreamCallAckExtensionFields(r randyE2ECall, easy bool) *UpstreamCallAckExtensionFields {
	this := &UpstreamCallAckExtensionFields{}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedE2ECall(r, 1)
	}
	return this
...
func NewPopulatedDownstreamCallExtensionFields(r randyE2ECall, easy bool) *DownstreamCallExtensionFields {
	this := &DownstreamCallExtensionFields{}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedE2ECall(r, 1)
	}
	return this
...
func randFieldE2ECall(dAtA []byte, r randyE2ECall, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateE2ECall(dAtA, uint64(v2))
	case 1:
		dAtA = encodeVarintPopulateE2ECall(dAtA, uint64(key))
